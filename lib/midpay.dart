...
///MidtransCallback
typedef MidtransCallback = Future<void> Function(TransactionFinished transactionFinished);
...
class Midpay {
  ...
  Future<void> init(String clientId, String url,
      {Environment environment = Environment.sanbox}) async {
    String env = 'sandbox';
